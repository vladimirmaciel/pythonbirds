...
class Motor:
    ...
    def frear(self):
        self.velocidade -= 2
        self.velocidade = max(0, self.velocidade)  # verificar qual o maior valor e atribuir a self.valor
...
class Direcao:
    ...
    rotacao_a_esquerda_dct = {
        OESTE: SUL, SUL: LESTE, LESTE: NORTE, SUL: LESTE, NORTE: OESTE
    }  # atributo de classe

    def __init__(self):  # atributo de instâcnia
        self.valor = NORTE
